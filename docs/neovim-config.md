...
The custom theme engine in `lua/themes/` loads `matugen_colors.lua` (legacy static color source; no longer regenerated by Matugen). The engine sets highlight groups for syntax, UI elements, and plugin integrations.
