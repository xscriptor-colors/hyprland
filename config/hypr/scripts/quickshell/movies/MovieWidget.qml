...
Item {
    ...
    component CustomComboBox: ComboBox {
        ...
        delegate: ItemDelegate {
            ...
            background: Rectangle { color: control.highlightedIndex === index ? window.surface1 : "transparent"; radius: window.s(13) }
        }
        indicator: Canvas {
            id: canvas
        ...
        background: Rectangle { implicitWidth: window.s(180); implicitHeight: window.s(36); color: window.surface0; border.color: control.activeFocus ? window.surface2 : window.surface1; border.width: control.visualFocus ? 2 : 1; radius: window.s(13) }
        popup: Popup {
            ...
            background: Rectangle { color: window.crust; border.color: window.surface1; radius: window.s(18) }
        }
    }

    component PosterDelegate: Rectangle {
        width: window.s(120); height: width * 1.5
        radius: window.s(13); color: window.crust; clip: true
        ...
        Rectangle {
            anchors.fill: parent; radius: window.s(13)
                    ...
                    Column {
                        ...
                        ListView {
                            ...
                            delegate: Rectangle {
                                ...
                                Rectangle {
                                    width: window.s(20); height: window.s(20); radius: window.s(13)
                    ...
                    Column {
                        ...
                        ListView {
                            ...
                            ScrollBar.horizontal: ScrollBar {
                                active: true
                                contentItem: Rectangle { radius: window.s(3); color: window.surface2 }
                            }
                        }
                    }
                }
    ...
    Rectangle {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            Layout.preferredWidth: window.s(200); Layout.preferredHeight: window.s(36); radius: window.s(13); color: window.surface0
                            Rectangle {
                                id: tabHighlight
                                width: parent.width / 2 - window.s(4); height: parent.height - window.s(8)
                                y: window.s(4); radius: window.s(10); color: window.mediaType === "movie" ? window.mauve : window.blue; z: 0
                ...
                Item {
                    ...
                    Component {
                        ...
                        Item {
                            z: 0
                            Rectangle {
                                color: window.surface0; border.color: window.surface1; border.width: 1; radius: window.s(13)
                    ...
                    Component {
                        ...
                        Item {
                            ...
                            Rectangle {
                                anchors.fill: parent; anchors.margins: window.s(5); radius: window.s(13); color: "transparent"
                                ...
                                ColumnLayout {
                                    ...
                                    Rectangle {
                                        Layout.fillWidth: true; Layout.fillHeight: true; radius: window.s(10); color: window.crust; clip: true
                    ...
                    GridView {
                        ...
                        ScrollBar.vertical: ScrollBar { active: true; contentItem: Rectangle { radius: window.s(3); color: window.surface2 } }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    Layout.fillWidth: true; Layout.preferredHeight: window.s(300); radius: window.s(18); color: window.crust; clip: true
                    Image {
                        anchors.fill: parent
                ...
                Flickable {
                    ...
                    ScrollBar.vertical: ScrollBar { contentItem: Rectangle { radius: window.s(3); color: window.surface2; implicitWidth: window.s(3) } }
                    Text {
                        id: descText
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            width: seasonLabelText.width + window.s(28); height: window.s(38); radius: window.s(13)
                ...
                Item {
                    ...
                    ListView {
                        ...
                        ScrollBar.vertical: ScrollBar { active: true; contentItem: Rectangle { radius: window.s(3); color: window.surface2; implicitWidth: window.s(4) } }
                        Text {
                            anchors.centerIn: parent
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            Layout.preferredWidth: window.s(32); Layout.preferredHeight: window.s(32); radius: window.s(10)
                ...
                Item {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            width: ListView.view.width; height: window.s(52); radius: window.s(13)
                            color: {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            Layout.fillWidth: true; Layout.preferredHeight: window.s(48); radius: window.s(13)
                        ...
                        Rectangle {
                            Layout.preferredWidth: window.s(110); Layout.preferredHeight: window.s(48); radius: window.s(13)
