...
Item {
    ...
    Rectangle {
        ...
        color: bar.topbarPillBg ? (isHovered ? Qt.rgba(colors.green.r, colors.green.g, colors.green.b, 0.15) : Qt.rgba(colors.surface0.r, colors.surface0.g, colors.surface0.b, 0.4)) : "transparent"
